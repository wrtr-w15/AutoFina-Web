...
export default function TechnicalSpecificationGuide() {
            ...
            <div className="space-y-8">
              ...
              >
                <h2 className="text-2xl font-semibold mb-4" style={{ color: theme.colors.foreground }}>
                  {t("guides.technicalSpec.section1.title")}
                </h2>
              ...
              >
                <h2 className="text-2xl font-semibold mb-4" style={{ color: theme.colors.foreground }}>
                  {t("guides.technicalSpec.section2.title")}
                </h2>
                <div className="space-y-4" style={{ color: theme.colors.mutedForeground }}>
                  <div>
                    <h3 className="font-medium mb-2" style={{ color: theme.colors.foreground }}>
                      {t("guides.technicalSpec.section2.item1.title")}
                    </h3>
                    <p>{t("guides.technicalSpec.section2.item1.content")}</p>
                  </div>
                  <div>
                    <h3 className="font-medium mb-2" style={{ color: theme.colors.foreground }}>
                      {t("guides.technicalSpec.section2.item2.title")}
                    </h3>
              ...
              >
                <h2 className="text-2xl font-semibold mb-4" style={{ color: theme.colors.foreground }}>
                  {t("guides.technicalSpec.section4.title")}
                </h2>
                <div className="space-y-4" style={{ color: theme.colors.mutedForeground }}>
